...
export class Secondpage extends React.Component {
   ...
   <g id="Layer_1_1_">
    ...
    <g id="Layer_2_1_">
        <g id="Layer_2-2">
            <rect y="197.4" class="sts0" width="747.7" height="3"/>
        </g>
        <g id="Layer_7">
            <path class="sts1" d="M0,136c0,0,275.1,7.1,358.1,31.6l0,0L516.6,196L0,198.1V136z"/>
            <path class="sts1" d="M747.7,200.4V154c0,0-327.2,18.5-371.1,5.3l0,0v35.4L747.7,200.4"/>
        </g>
        <g id="Layer_6">
            <path class="sts2" d="M744.6,166.7c0,0-150.1,2.6-188,9c0,0-129.4-23.9-144.7-11.5c0,0-165.3-32.5-236.3-3.7L0,156.7V198
                l747.7,2.3v-33.7"/>
        </g>
        <g id="Layer_4">
            <path class="sts3" d="M0,149.7c0,0,103.6-10.1,175.6,10.9c0,0,125.5-5.8,182.5,8.5l0,0c0,0,115.6,2.6,122.5,13l0,0
                c0,0,63,2.2,83,0.9c0,0,135.1-16.3,184,0.1v17.5L0,198.1V149.7z"/>
        </g>
        <g id="Layer_5">
            <path class="sts3" d="M670.1,157.8c0,0-4,0-1.8,11c0,0-3.5,1.8-4-5.5c0,0-2.2-2.6-3,0.1c0,0,2.5,8.4,4.4,8.7
            ...
            <path class="sts4" d="M597.1,165.2c0,0-1.5,0-0.7,4.3c0,0-1.3,0.7-1.5-2.1c0,0-0.9-1-1.2,0c0,0,1,3.2,1.7,3.4
...
<g id="Layer_4_1_">
    <g id="Layer_3">
        <path class="sts0" d="M0,197.4"/>
        <circle class="sts5" cx="78.6" cy="27" r="27"/>
    </g>
</g>
<g id="Layer_3_1_">
    <g id="Layer_2">
        <g id="Layer_1-2">
            <g id="Layer_2-3">
                <g id="Layer_2-2-2">
                    <circle class="sts0" cx="18" cy="191.7" r="5.7"/>
                    <circle class="sts0" cx="-6.2" cy="191.7" r="5.7"/>
                    <circle class="sts0" cx="5.9" cy="191.7" r="5.7"/>
                    <circle class="sts0" cx="-18.3" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-25.2" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-32.1" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-62.3" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-69.2" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-76" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-138" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-151.5" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-176.1" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-182.9" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-189.8" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-251.7" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-258.5" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-265.4" cy="194.2" r="3.2"/>
                    <circle class="sts0" cx="-144.7" cy="194.2" r="3.2"/>
                    <path class="sts0" d="M27,179.3v-13.6h-1.9v-1.9H27v-2.4h-5.8v2.4h1.5v2h-5.8V164h2.7v-4.7H9.7v4.6h2.1v1.7H7.4v-3.9l-1.1-1.1H4
                    ...
                    <g id="Layer_3-2">
                        <line class="sts6" x1="26.6" y1="171.2" x2="-13.5" y2="171.2"/>
                        <polyline class="sts6" points="26.6,177.7 13.4,177.7 10.5,181.5 -31.1,181.5 -34.6,177.9 -38.4,177.9                      "/>
                        <line class="sts6" x1="-13.5" y1="164.2" x2="-13.5" y2="181.5"/>
                    </g>
                    <line class="sts6" x1="-11.2" y1="166.2" x2="26.6" y2="166.2"/>
                    <rect x="-71" y="165.7" class="sts7" width="11.7" height="24.1"/>
                    <rect x="-184.8" y="165.8" class="sts7" width="11.7" height="24.1"/>
                    <line class="sts7" x1="-57.7" y1="163.5" x2="-156.7" y2="163.5"/>
                    <line class="sts7" x1="-171.6" y1="163.5" x2="-271" y2="163.5"/>
                    <polyline class="sts7" points="-167.2,178.3 -171.6,181.9 -189.8,181.9 -193.1,183.7 -247.6,183.7 -251.7,182.1 -271,182.1 
                                            "/>
                    <line class="sts6" x1="-11.2" y1="156.7" x2="-38.4" y2="156.7"/>
                    <path class="sts6" d="M-11.2,165.4"/>
                    <polyline class="sts7" points="-53.1,178.4 -57.7,181.2 -76,181.2 -78.7,183.9 -133.2,183.9 -136,181.2 -156.8,181.2                    "/>
                    <rect x="-126.1" y="165.8" class="sts7" width="16.8" height="24.1"/>
                    <line class="sts7" x1="-117.7" y1="165.8" x2="-117.7" y2="189.9"/>
                    <rect x="-239.8" y="165.8" class="sts7" width="16.8" height="24.1"/>
                    <line class="sts7" x1="-231.4" y1="165.8" x2="-231.4" y2="189.9"/>
                </g>
            </g>
        </g>
    </g>
